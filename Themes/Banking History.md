...
category: economy
period: All
tags: [banking, finance, money, credit, economy]
---

# Banking History

Banking—the business of receiving deposits and making loans—developed to solve fundamental economic problems: how to transfer money safely, how to mobilize savings for investment, how to manage risk. From Mesopotamian temple loans to modern central banks, financial institutions have enabled (and sometimes disrupted) economic development. Banking history illuminates how credit, trust, and state power interacted to create modern economies.

## Overview

| Feature | Description |
|---------|-------------|
| Definition | Deposit, lending, transfer |
| Origins | Ancient temples, merchants |
| Development | Medieval Italy, early modern |
| Modern | Central banks, global finance |
...
|-------------|----------|
| Temples | Deposits, loans |
| Palaces | State credit |
| Interest | Established practice |
| Records | Clay tablets |

### Classical Antiquity

| Society | Practice |
|---------|----------|
| Greece | Money changers, loans |
| Rome | Argentarii (bankers) |
| Functions | Exchange, deposit, transfer |
| Scale | Limited |
...
|-------------|--------------|
| Bills of exchange | Payment without moving coin |
| Double-entry bookkeeping | Accounting revolution |
| Bank deposits | Interest-bearing |
...
| Peruzzi | Florence |
| Medici | Florence |
| Failures | Common (sovereign default) |
...
|-------------|------------|
| Wisselbank (1609) | Deposit bank |
| Function | Stable money |
| Trade | Enabled Dutch commerce |
| Model | For later banks |
...
| Government | Special relationship |
| Model | Central banking |
...
| Receipts | Circulated as money |
| Lending | Fractional reserves |
...
|------|---------|
| Note issue | Currency |
| Lender of last resort | Crisis management |
| Monetary policy | Price stability |
| Bank regulation | System stability |

### Development

| Period | Evolution |
|--------|-----------|
| 17th-18th c. | Early central banks |
| 19th century | Gold standard |
| 20th century | Modern central banking |
...
| Period | Character |
|--------|-----------|
| 19th century | Industrial finance |
| Early 20th | Branch banking |
| Mid 20th | Regulated |
| Late 20th | Deregulation |
...
| Factor | Mechanism |
|--------|-----------|
| Runs | Confidence collapse |
| Bad loans | Asset quality |
| Contagion | Spreading panic |
| Leverage | Excessive risk |
...
|-------------|-------------|
| Riba (interest) | Profit-sharing |
| Gharar (uncertainty) | Asset-backed |
| Haram activities | Ethical screening |
