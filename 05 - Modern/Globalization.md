...
category: economy
period: Modern
tags: [globalization, trade, integration, economy, development]
---

# Globalization

Globalization—the intensifying interconnection of economies, societies, and cultures across the world—has occurred in waves throughout history. The current phase, accelerating since the 1980s, has created unprecedented trade flows, capital mobility, and communication links. Earlier globalizations include the age of exploration, the late 19th century trade boom, and the post-WWII Bretton Woods system. Each wave transformed economies and sparked debates about winners and losers.

## Overview

| Feature | Description |
|---------|-------------|
| Definition | Global interconnection |
| Dimensions | Economic, cultural, political |
| Current phase | 1980s-present |
| Historical | Previous waves |
| Debate | Benefits and costs |
...
| Feature | Character |
|---------|-----------|
| [[Columbian Exchange]] | Biological, economic |
| [[Silver Trade]] | Global money flows |
| European expansion | Colonial networks |
| Mercantilism | Trade philosophy |

### First Modern Globalization (1870-1914)

| Feature | Character |
|---------|-----------|
| Trade | Dramatic expansion |
| Capital | International investment |
| Migration | Mass movement |
| Technology | Steam, telegraph |
| End | World War I |

### Interwar Retreat (1914-1945)

| Feature | Character |
|---------|-----------|
| World War I | Disruption |
| Protectionism | Tariff barriers |
| [[Great Depression]] | Collapse |
| Autarky | Self-sufficiency |
| World War II | Further disruption |

### Bretton Woods Era (1945-1973)

| Feature | Character |
|---------|-----------|
| Institutions | IMF, World Bank, GATT |
| Currency | Dollar standard |
| Trade | Liberalization |
| Growth | "Golden age" |
| End | Nixon shock 1971 |

### Current Globalization (1980s-present)

| Feature | Character |
|---------|-----------|
| Trade | Accelerating |
| Capital | Financial globalization |
| Technology | Digital revolution |
| Supply chains | Global fragmentation |
...
| Development | Effect |
|-------------|--------|
| Liberalization | Tariff reduction |
| WTO | Rules-based system |
| Volume | Dramatic increase |
| Composition | Services growing |

### Capital Flows

| Type | Character |
|------|-----------|
| FDI | Production relocation |
| Portfolio | Financial investment |
| Banking | Global institutions |
| Scale | Massive flows |
...
| Change | Example |
|--------|---------|
| Supply chains | Globally distributed |
| Outsourcing | Manufacturing shift |
| Specialization | By country, region |
| Trade in tasks | Components |

### Migration

| Pattern | Character |
|---------|-----------|
| Labor migration | North-South, South-South |
| Brain drain/gain | Skilled workers |
| Remittances | Major flows |
| Restrictions | Growing barriers |
...
| WTO | Trade rules |
| UNCTAD | Development focus |

### Regional Agreements

| Agreement | Character |
|-----------|-----------|
| EU | Deepest integration |
| NAFTA/USMCA | North American |
...
| Role | Character |
|------|-----------|
| Multinationals | Global production |
| Supply chains | Coordination |
| Investment | Major actors |
| Power | Considerable |
...
| Argument | Evidence |
|----------|----------|
| Growth | Trade correlation |
| Poverty reduction | Asian development |
| Consumer prices | Lower goods costs |
| Technology transfer | Knowledge spread |
...
| Job displacement | Manufacturing loss |
| Race to bottom | Labor, environment |
| Sovereignty | Policy constraints |

### Winners and Losers

| Group | Effect |
|-------|--------|
| Skilled workers | Generally benefit |
| Manufacturing workers | Displaced in developed |
| Consumers | Lower prices |
| Developing countries | Mixed |
...
| Period | Response |
|--------|----------|
| Post-1914 | Retreat, protectionism |
| 1930s | Depression response |
| Post-2008 | Rising skepticism |
...
| Nationalism | Domestic preference |
| COVID-19 | Supply chain concerns |
...
| Regionalization | Alternative pattern |
| Digital | New phase |
...
- Frieden, J. (2006). *Global Capitalism*
- O'Rourke, K. & Williamson, J. (1999). *Globalization and History*
