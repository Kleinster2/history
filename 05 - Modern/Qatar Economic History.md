...
### Pre-Modern Economy (7000 BCE-1871)

| Period | Economic Base |
|--------|---------------|
| Neolithic (7000-5000 BCE) | Hunter-gatherer, coastal fishing |
| Bronze Age (3000-1000 BCE) | Trade links to Dilmun civilization |
| Islamic Era (636-1700s) | Pearl diving, fishing, nomadic herding |
...
| Feature | Detail |
|---------|--------|
| Status | Ottoman suzerainty, local autonomy |
...
### The Pearl Economy's Apex and Collapse (1916-1940s)

| Phase | Timeframe | Characteristics |
|-------|-----------|----------------|
| Peak | 1900-1920 | 800+ boats, ~13,000 workers |
...
### Economic Crisis and Transition (1930s-1949)

| Indicator | 1930 | 1940 |
|-----------|------|------|
| Pearl fleet | ~800 boats | <100 boats |
| Employment | ~13,000 workers | ~1,500 workers |
...
### Commercial Production and State Building

| Milestone | Year | Details |
|-----------|------|---------|
| Discovery | 1939 | Dukhan field, Upper Jurassic limestone |
| First exports | 1949 | 4,000 barrels/day from Umm Said |
| Revenue sharing | 1952 | 50-50 profit split with oil companies |
| Gas flaring | 1950s-1970s | Wasted associated gas |

World War II delayed development, but production began in 1949. Unlike the pearl economy's boom-and-bust volatility, oil provided steady revenue flows that enabled long-term state planning. Sheikh Ali bin Abdullah Al Thani (r. 1949-1960) used oil revenues to build Qatar's first modern infrastructure: hospitals, schools, roads, and water systems.

The oil-for-development model followed other Gulf states but with key differences:
- **Scale**: Qatar's small population (25,000 by 1970) meant per-capita oil wealth was extreme
- **Timing**: Late entry to oil production meant learning from Kuwait and Saudi mistakes
- **Gas awareness**: Early recognition that associated gas was being wasted

## Independence and Gas Focus (1971-1995)
...
|-----------|------|-------------|
| Discovery | 1971 | World's largest non-associated gas field |
| Initial disappointment | 1970s | "People hoped for oil" (Al-Attiyah) |
...
## The Hamad Revolution (1995-2013)

### The 1995 Coup and Economic Acceleration

Sheikh Hamad bin Khalifa Al Thani seized power from his father in a bloodless coup (June 27, 1995) while Khalifa was abroad. The power transition accelerated economic modernization and established Qatar's activist foreign policy.

### LNG Industrialization Strategy

| Project | Startup | Capacity | Partners |
|---------|---------|----------|----------|
| Qatargas 1 | 1997 | 10 mtpa | Shell, BP, Exxon |
| RasGas 1 | 1999 | 4.7 mtpa | ExxonMobil |
...
| Institution | Founded | Assets (2013) | Strategy |
|-------------|---------|---------------|----------|
| Qatar Investment Authority | 2005 | ~$170 billion | Global diversification |
| Qatari Diar | 2004 | Property arm | Real estate focus |
| Qatar Holding | 2006 | QIA subsidiary | Strategic investments |

The Qatar Investment Authority's creation marked recognition that gas wealth, like oil, was finite. QIA's mandate: convert hydrocarbons underground into financial assets above ground. Early investments focused on London real estate, European banks, and luxury brands.
...
### Leadership Transition and Vision 2030

Emir Tamim bin Hamad Al Thani assumed power in 2013, inheriting an economy transformed from subsistence-level poverty to extreme wealth within two generations. Vision 2030 addresses the challenge facing all Gulf states: maintaining prosperity after hydrocarbons.

### Economic Resilience Testing

#### 2017 GCC Blockade

The Saudi-UAE-Bahrain-Egypt blockade (2017-2021) tested Qatar's economic resilience:

| Impact | Mitigation |
|--------|------------|
| Food imports cut | Turkey, Iran alternative supply |
| Investment flight | QIA liquidity buffer |
| Trade routes blocked | New shipping via Oman |
| Tourism decline | Domestic infrastructure acceleration |

Qatar's successful blockade resistance demonstrated economic diversification benefits. LNG exports continued unaffected, QIA holdings provided foreign exchange, and alternative trade routes proved viable.

#### 2026 Iran Conflict

Iran's March 2026 missile strike on Ras Laffan represents the most severe threat to Qatar's economic model since the pearl collapse. Physical damage to LNG infrastructure and force majeure on shipments challenge the assumption that energy wealth provides security.

## Lessons and Patterns

### Institutional Development

Qatar's economic success stems from institutional choices that enabled wealth management:

| Institution | Function | Key Decision |
|-------------|----------|-------------|
| QatarEnergy | Resource management | State ownership retained |
| QIA | Wealth preservation | Early establishment (2005) |
| Al Thani consensus | Political stability | Managed succession |
| Foreign partnerships | Technology transfer | Balanced alliances |

### Economic Transformation Mechanism
...
- Fromherz, A. (2017). *Qatar: A Modern History*
- Qatar National Vision 2030 (Government of Qatar, 2008)
- Kamrava, M. (2013). *Qatar: Small State, Big Politics*
- Qatar Digital Library (British Library/Qatar National Library)
- Al-Attiyah, A. (former energy minister), quoted in New York Times (2018)
- OPEC Annual Statistical Bulletin (1970-2026)
- QatarEnergy annual reports and force majeure declarations (2026)
- World Bank development indicators for Qatar (1970-2026)